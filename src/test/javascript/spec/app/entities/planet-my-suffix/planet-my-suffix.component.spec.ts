...
import { PlanetMySuffixComponent } from 'app/entities/planet-my-suffix/planet-my-suffix.component';
...
describe('Component Tests', () => {
    describe('PlanetMySuffix Management Component', () => {
        let comp: PlanetMySuffixComponent;
        let fixture: ComponentFixture<PlanetMySuffixComponent>;
        let service: PlanetMySuffixService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [SolarSystemTestModule],
                declarations: [PlanetMySuffixComponent],
                providers: [
                    {
                ...
                .overrideTemplate(PlanetMySuffixComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(PlanetMySuffixComponent);
